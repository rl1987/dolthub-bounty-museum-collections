...
class MamparisSpider(scrapy.Spider):
    ...
    def parse_search_results(self, response):
        ...
        for result_dict in results:
            ...
            maker_full_name = list(map(lambda a: a.get("name", dict()).get("notice2"), authors))
            ...
            if type(item['acquired_year']) == float or (type(item['acquired_year']) == str and "." in item['acquired_year']):
            ...
            item['source_1'] = 'https://www.mam.paris.fr/fr/collections-en-ligne#/artwork/' + item['object_number']
            item['source_2'] = 'https://api.navigart.fr/18/artworks/' + item['object_number']
