...
class BurkeSpider(scrapy.Spider):
    ...
    def parse_artwork_page(self, response):
        ...
        item['object_number'] = response.xpath('//tr[./td[text()="Object #"]]/td[@class="resultsData"]/text()').get()
        ...
        item['department'] = response.xpath('//ol[contains(@class, "breadcrumbs")]/li[.//a][last()]//a/text()').get()
        # XXX: category
        item['title'] = response.xpath('//tr[./td[text()="Object name"]]/td[@class="resultsData"]/text()').get()
        # XXX: description, current_location
        item['dimensions'] = response.xpath('//tr[./td[text()="Dimensions"]]/td[@class="resultsData"]/text()').get()
        # XXX: inscription, provenance
        item['materials'] = response.xpath('//tr[./td[text()="Materials"]]/td[@class="resultsData"]/text()').get()
        item['technique'] = response.xpath('//tr[./td[text()="Techniques"]]/td[@class="resultsData"]/text()').get()
        # XXX: from_location
        item['culture'] = response.xpath('//tr[./td[text()="Culture of Origin"]]/td[@class="resultsData"]/text()').get()
        # XXX: date_description
        item['maker_full_name'] = response.xpath('//tr[./td[text()="Maker or Artist"]]/td[@class="resultsData"]/text()').get()
        item['acquired_from'] = response.xpath('//tr[./td[text()="Source"]]/td[@class="resultsData"]/text()').get()
        item['credit_line'] = response.xpath('//tr[./td[text()="Credit"]]/td[@class="resultsData"]/text()').get()
