...
class AshmoleanSpider(scrapy.Spider):
    ...
    def parse_object_page(self, response):
        ...
        item["department"] = (
            response.xpath(
                '//li[./div/p[text()="Museum department"]]/div[@class="right-wrap"]//p/text()'
            )
            .get("")
            .strip()
        )
        item["category"] = (
            response.xpath(
                '//li[./div/p[text()="Object type"]]/div[@class="right-wrap"]//a/text()'
            )
            .get("")
            .strip()
        )
        ...
        item["description"] = " ".join(
            response.xpath('//div[@class="item-descrption"]/div/p/text()').getall()
        )
        item["current_location"] = (
            response.xpath(
                '//li[./div/p[text()="Museum location"]]/div[@class="right-wrap"]//a/text()'
            )
            .get("")
            .strip()
        )
        item["dimensions"] = (
            response.xpath(
                '//li[./div/p[text()="Dimensions"]]/div[@class="right-wrap"]/div/text()'
            )
            .get("")
            .strip()
        )
        item["materials"] = (
            response.xpath(
                '//li[./div/p[text()="Material and technique"]]/div[@class="right-wrap"]/div/p/text()'
            )
            .get("")
            .strip()
        )
        item["from_location"] = "|".join(
            response.xpath(
                '//li[./div/p[text()="Associated place"]]/div[@class="right-wrap"]//a/text()'
            ).getall()
        )
        item["date_description"] = (
            response.xpath(
                '//li[./div/p[text()="Date"]]/div[@class="right-wrap"]/text()'
            )
            .get("")
            .strip()
        )
        item["maker_full_name"] = (
            response.xpath(
                '//li[./div/p[text()="Artist/maker"]]/div[@class="right-wrap"]//a/text()'
            )
            .get("")
            .strip()
        )
        item["accession_number"] = (
            response.xpath(
                '//li[./div/p[text()="Accession no."]]/div[@class="right-wrap"]/div/p/text()'
            )
            .get("")
            .strip()
        )
        item["credit_line"] = (
            response.xpath(
                '//li[./div/p[text()="Credit line"]]/div[@class="right-wrap"]/div/p/text()'
            )
            .get("")
            .strip()
        )
